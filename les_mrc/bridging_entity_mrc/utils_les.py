...
def read_squad_examples(input_file, is_training, version_2_with_negative):
    ...
    with open(input_file) as fin:
        ...
        for line_id, line in enumerate(fin):
            ...
            if is_training:
                # bridging_entity_labels字段代表(docid, start, end)
                ...
                if no_bridging_entity_label:
                    ...
                    match_doc_id = sample['bridging_entity_labels'][0]
                    sample['bridging_entity_labels'] = [sample['bridging_entity_labels'][1], sample['bridging_entity_labels'][2]]
                ...
                for doc_id in range(context_num):  # doc_id代表进行到一个例子中的第几个documents了
                    ...
                    # 该样本不包含 bridging_entity，则所有样本 is_impossible=True
                    if no_bridging_entity_label:
                    ...
                    if doc_id == match_doc_id:  # 该document有答案
                        start, end = sample['bridging_entity_labels']
                        qas_id = '{}##{}##{}'.format(sample['question_id'], doc_id, 1)
            ...
            if print_sample_cnt < 5:
                if not span_is_impossible:
                    ...
                    if is_training and not span_is_impossible:
                        ...
                        logger.info("orig_answer_text: %s" % example.orig_answer_text)
