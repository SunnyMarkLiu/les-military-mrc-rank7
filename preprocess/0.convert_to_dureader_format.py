...
for rid, row in tqdm(train_df.iterrows(), total=train_df.shape[0]):
    ...
    if row['question_id'] == 'Q_14092hckjc':
        sample['supporting_paragraph'] = "斯普林菲尔德M1903步枪全枪重：3.9千克斯普林菲尔德M1903步枪是一种旋转后拉式枪机弹仓式手动步枪，1903年定型称为“0.30口径M1903步枪”，因其由斯普林菲尔德(Springfield)兵工厂研制而得名斯普林菲尔德步枪（Springfieldrifle），也有译成春田兵工厂而称为春田步枪，是美军在一战及二战的制式步枪。"
