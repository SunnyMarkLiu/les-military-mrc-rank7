...
train_df = pd.read_csv('../input_rollback_8315/original/train_round_0.csv', sep=',')
test_df = pd.read_csv('../input_rollback_8315/original/test_data_r0.csv', sep=',')

train_file_out = open('../input_rollback_8315/raw/train_round_0.json', 'w', encoding='utf8')
test_file_out = open('../input_rollback_8315/raw/test_data_r0.json', 'w', encoding='utf8')
