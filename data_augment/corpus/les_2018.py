...
military_corpus_fout = open('../../input/military_corpus/les_2018.txt', 'w', encoding='utf8')

with open('../../input/military_corpus/les_2018_train.json', 'r') as f:
    samples = json.load(f)

    for sample in tqdm(samples):
        content = clean_text(sample['article_content'])
